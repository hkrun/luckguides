      ...
      <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50">
        <a
          ...
          rel="nofollow noopener"
           className="bg-[#8B4513] hover:bg-[#8B4513]/80 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center group w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16"
        >
          <svg
